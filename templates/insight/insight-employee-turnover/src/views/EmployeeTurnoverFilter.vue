        ...
        <mp-box>
          <mp-autocomplete
            ...
            :data="[
              {
                value: 'all',
                name: 'All resigned employee',
                group: 'RESIGN TYPE',
              },
              {
                value: 'involuntary-resigned-employee',
                name: 'Involuntary resigned employee',
                group: 'RESIGN TYPE',
              },
              {
                value: 'voluntary-resigned-employee',
                name: 'Voluntary resigned employee',
                group: 'RESIGN TYPE',
              },
            ]"
...
import AdvancedDatepicker from "../components/custom/AdvancedDatepicker";

export default {
  name: "EmployeeTurnoverFilter",
  components: {
    MpFlex,
    MpBox,
    MpText,
