      ...
      menus: [
        {
          ...
          icon: "flag",
          link: "/",
          isActive: this.$router.currentRoute.name === "GettingStarted",
          items: [],
        },
        {
          parentId: 2,
        ...
        },
        {
          ...
          icon: "products",
          link: "/offers",
          isActive: ["Offers", "OffersDetail", "OffersOverview"].includes(
        ...
        },
        {
          ...
          icon: "payslip",
          link: "/commission",
          isActive: this.$router.currentRoute.name === "Commission",
          items: [],
        },
        {
          parentId: 5,
          ...
          icon: "profile",
          link: "/personal-info",
          isActive: this.$router.currentRoute.name === "PersonalInfo",
          items: [],
        },
      ],
    };
