<template>
  <mp-box ref="popover">
    <mp-popover :is-open="ispopoveropen" is-manual>
      <mp-popover-trigger>
        <mp-button
          variant="unstyled"
          height="auto"
      ...
      >
        ...
        <mp-box :display="companylisttoggle ? 'block' : 'none'">
          ...
          >
            ...
            />
            <mp-text font-weight="semibold"> Company list </mp-text>
          </mp-popover-header>
          <mp-popover-list border-bottom-radius="md">
            ...
            <mp-popover-list-item>SP-holding</mp-popover-list-item>
          </mp-popover-list>
          <mp-button
            variant="unstyled"
            width="full"
        ...
        <mp-box :display="parenttoggle ? 'block' : 'none'">
          ...
          <mp-popover-list>
            <mp-popover-list-item>Settings</mp-popover-list-item>
            <mp-popover-list-item
              is-arrow
          ...
          <mp-popover-list>
            <mp-popover-list-item justify-content="space-between">
              Mekari account
            ...
            <mp-popover-list-item>Help</mp-popover-list-item>
          ...
          <mp-flex gap="3" flex-wrap="wrap" padding-x="3" padding-y="4">
            ...
            <mp-text font-size="xs" color="gray.600">Mekari © 2023</mp-text>
          </mp-flex>
        </mp-box>
      </mp-popover-content>
    </mp-popover>
