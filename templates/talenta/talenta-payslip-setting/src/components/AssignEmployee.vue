    ...
    <mp-drawer-content width="920px" max-width="920px">
      ...
      <mp-drawer-body overflow-x="auto" padding="0">
        <mp-text font-weight="semibold" margin-left="4" margin-top="4" margin-bottom="6">
          Which employee would you like to assign payslip for Headoffice?
        </mp-text>
        <mp-flex height="calc(100vh - 190px)">
          <mp-box width="50%" border-right="1px" border-color="gray.100">
            <mp-box v-if="!isShowFilter">
              <mp-flex gap="6" justify-content="space-between" align-items="center" margin-top="0" margin-bottom="6"
                ...
                <mp-box>
                  <mp-button variant="outline" left-icon="filter" @click="() => handleToggleFilter(true)">
                    Filters
                  </mp-button>
                </mp-box>
              </mp-flex>
              ...
              <mp-flex v-for="(employee, index) in employees" :key="employee.name" role="group"
                justify-content="space-between" align-items="flex-start" padding-y="3" padding-x="2" margin-left="4"
                margin-right="6" border-bottom="1px" border-color="gray.100" cursor="pointer"
                ...
                <mp-box text-align="right" opacity="0" visibility="hidden" transition="all .2s ease" :_groupHover="{
                    opacity: '1',
                    visibility: 'visible',
                  }">
            ...
            <mp-box v-if="isShowFilter">
              <mp-flex justify-content="space-between" align-items="center" margin-bottom="4" height="36px"
                padding-left="4" padding-right="6">
                <mp-flex gap="2" align-items="center">
                  <mp-icon name="chevrons-left" />
                  <mp-button color="gray.600" variant="link" @click="() => handleToggleFilter(false)">
              ...
              <mp-box max-height="calc(100vh - 245px)" overflow="hidden auto" padding-left="4" padding-right="6">
                <mp-accordion allow-toggle allow-multiple>
                  <mp-accordion-item>
                    <mp-accordion-header padding-x="0" padding-y="0" :is-clickable="false">
                      <mp-flex flex="1 0 0" justify-content="space-between" height="16">
                    ...
                    <mp-accordion-panel padding-x="0" padding-top="0" padding-bottom="3">
                ...
                <mp-flex justify-content="space-between" margin-top="7">
                  <mp-box @mouseover="isoutsidepopover = false" @mouseleave="isoutsidepopover = true">
                    <mp-popover :is-open="ispopoveropen" initial-focus-ref="#filter-search" placement="top-start"
                      is-manual>
                      <mp-popover-trigger>
                        <mp-box>
                          <mp-button color="blue.400" font-weight="semibold" variant="ghost" @click="handleOpenPopover">
                            <mp-icon name="add" color="blue.400" variant="outline" size="sm" margin-right="2" />
                            Add filter
                          </mp-button>
                        </mp-box>
                      </mp-popover-trigger>
                      <mp-popover-content max-width="264px" background-color="white" border-radius="md"
                        border-width="1px" border-color="gray.400" box-shadow="lg" padding-y="2"
                        ...
                        <mp-box margin-top="2" margin-bottom="2" padding-x="3">
                          <mp-input-group>
                            ...
                            <mp-input id="filter-search" placeholder="Search..." @focus="handleFocus"
                  ...
                  <mp-button color="blue.400" font-weight="semibold" variant="outline">
                    Apply filter
                  </mp-button>
                </mp-flex>
              </mp-box>
          ...
          <mp-box width="50%">
            ...
            <mp-flex v-if="this.selectedEmployees.length !== 0" align-items="center" justify-content="space-between"
              padding-right="4" padding-left="6" padding-top="0" margin-bottom="4">
            ...
            <mp-box v-if="this.selectedEmployees.length === 0" text-align="center" padding-x="6">
              <mp-icon name="people" color="blue.400" variant="fill" width="56px" height="56px" margin-bottom="6" />
              <mp-heading as="h3" font-size="lg" font-weight="bold">
            ...
            <mp-flex v-for="(employee, index) in selectedEmployees" :key="employee.name" role="group"
              justify-content="space-between" align-items="center" padding-y="3" padding-x="2" margin-right="4"
              margin-left="6" border-bottom="1px" border-color="gray.100" cursor="pointer"
      ...
      <mp-drawer-footer padding-x="6" padding-y="5">
        ...
        <mp-button @click="handleAssign">Assign employee</mp-button>
      </mp-drawer-footer>
    </mp-drawer-content>
  </mp-drawer>
</template>
