<template>
  ...
  >
    <mp-flex justify-content="space-between" margin-bottom="6">
      <mp-box>
        <mp-heading as="h2" font-size="xl">
          Yearly cost to company
        </mp-heading>
        <mp-text color="gray.600">
          Cost to company based on salary range within yearly
        </mp-text>
      </mp-box>
    ...
    <mp-flex gap="6" border="1px solid" border-color="gray.100" border-radius="md" margin-bottom="6" padding="2">
      <mp-flex flex="1 0 0" flex-direction="column" padding="4" border-right="1px solid" border-right-color="gray.100">
        <mp-heading as="h2" font-size="xl">
          Rp2.190.000.000
        </mp-heading>
        <mp-text color="gray.600">
          Est. Total Actual Min. Salary Cost
      ...
      <mp-flex flex="1 0 0" flex-direction="column" padding="4" border-right="1px solid" border-right-color="gray.100">
        ...
        <mp-text color="gray.600">
          Est. Total Actual Mid. Salary Cost
          <mp-icon name="info" size="sm" margin-left="1" />
        </mp-text>
      </mp-flex>
      <mp-flex flex="1 0 0" flex-direction="column" padding="4">
        <mp-heading as="h2" font-size="xl">
          Rp3.588.000.000
        </mp-heading>
        <mp-text color="gray.600">
          Est. Total Actual Max. Salary Cost
          <mp-icon name="info" size="sm" margin-left="1" />
        </mp-text>
      </mp-flex>
    </mp-flex>
