<template>
  <mp-box v-bind="$attrs">
      ...
      <mp-table :isHoverable="isHoverable">
        <mp-table-head :is-fixed="isFixed">
          <mp-table-row
            ...
            :position="showBulkAction ? 'relative' : ''"
          >
            ...
            >
              <mp-box v-if="!showBulkAction" cursor="pointer">
                ...
                <template v-if="isSortable && !head.disableSorting">
                  <mp-icon
                    :name="head.sort ? `sort-${head.sort}` : 'sort-default'"
                  />
                </template>
              </mp-box>
            </mp-table-cell>
    ...
    <!-- Pagination -->
    <mp-box
      v-if="usePagination && !loading && !hasNoItems"
      padding-x="2"
      padding-y="4"
    >
            ...
            >
              <mp-popover-list>
                <mp-popover-list-item
                  v-for="value in rowsPerpage"
                  :key="value"
                  :is-active="value === currentPerPage"
