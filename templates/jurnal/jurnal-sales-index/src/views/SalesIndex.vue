    ...
    <mp-flex as="main" max-height="calc(100vh - 60px)">
      ...
      >
        ...
        >
              ...
              <mp-tab-list>
                ...
                <mp-tab>
                  ...
                  <mp-badge
                    ...
                    variant="solid"
                    :variant-color="
                      currentTab === 'require-approval' ? 'blue' : 'gray'
                    "
                  >
                    3
                  </mp-badge>
            ...
            >
              ...
              <template #default="{ item, index }">
                ...
                <mp-table-cell as="td" scope="row">
                  <mp-badge
                    variant="subtle"
                    :variant-color="getBadgeVariantColor(item.status)"
                  >
                    {{ item.status }}
                  </mp-badge>
                </mp-table-cell>
                <mp-table-cell as="td" scope="row">
                  <mp-text text-align="right" font-size="md" line-height="md">{{
                    item.balance
                  }}</mp-text>
                </mp-table-cell>
                <mp-table-cell as="td" scope="row">
                  ...
                  <mp-flex align="center" justify="end" gap="2">
                    ...
                    <mp-popover :id="`popover-approval-log-${index}`">
                      <mp-popover-trigger>
                        <mp-box>
                          <mp-tooltip
                            label="Log persetujuan"
                            :id="`tooltip-approval-log-${index}`"
                          >
                      ...
                      <mp-popover-content max-width="392px" z-index="popover">
                        <mp-popover-panel bg="white" px="4">
                          <mp-text font-weight="semibold" mb="4"
                            >Approval Log</mp-text
                          >

                          <PopoverTimelineAccordion v-if="index === 0" />
                          <PopoverTimeline v-if="index === 1" />
                          <mp-box v-if="index === 2" my="8">
                            <mp-text text-align="center" color="gray.400"
                              >No approval logs for this transaction.</mp-text
                            >
                          </mp-box>
                        </mp-popover-panel>
                      </mp-popover-content>
                    ...
                    >
                      <mp-box position="relative">
                        <mp-button-icon
                          name="comment"
                          @click="handleOpenModalChat(index)"
                        />
                        <mp-badge
                          v-if="index === 0"
                          position="absolute"
          ...
          <ModalDelete
            @handleClose="isModalDeleteOpen = false"
            name="Sales Invoice"
            :isOpen="isModalDeleteOpen"
          />
          <ModalPrintPdf
            @handleClose="isModalPrintPdfOpen = false"
            :isOpen="isModalPrintPdfOpen"
          />
          <ModalChat
            :type="modalChatType"
            :isApproved="modalChatApproved"
            :is-open="isModalChatOpen"
            @handleClose="isModalChatOpen = false"
          />
        </mp-box>
      </mp-box>
    </mp-flex>
