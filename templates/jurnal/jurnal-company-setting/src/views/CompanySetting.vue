                  ...
                  >
                    <mp-flex flex-direction="column" gap="2" py="2">
                      ...
                      <mp-text
                        color="gray.600"
                        font-size="sm"
                        v-if="tempInfoTambahan.imageUrl"
                        >Logo ini akan muncul di detail dan preview
                        transaksi</mp-text
                      >
                      <mp-text color="gray.600" font-size="sm" v-else
                        >Format file JPG atau PNG (maks. 2 MB)</mp-text
                      >
                      ...
                      <mp-flex v-if="storedInfoTambahan.imageUrl">
                        ...
                        >
                          <mp-box
                            ...
                            h="8"
                            w="auto"
                            :src="storedInfoTambahan.imageUrl"
                            alt=""
                          />
                        </mp-box>
                      </mp-flex>
              ...
              <mp-stack spacing="16">
                ...
                <mp-box>
                    ...
                    <mp-flex flex-direction="column" py="1.5">
                      <mp-box pb="4">
                        ...
                        <mp-autocomplete
                          ...
                          @change="
                            (value) =>
                              (tempPengaturanFiturTambahan.mataUang = value)
                          "
                      ...
                      <mp-box pb="4">
                        ...
                        <mp-autocomplete
                          ...
                          @change="
                            (value) =>
                              (tempPengaturanFiturTambahan.formatMataUang = value)
                          "
                          :content-style="{ width: 64, zIndex: 'popover' }"
                        />
                      </mp-box>
                  ...
                  <mp-flex
                    v-else
                    flex-direction="column"
                    key="view-pengaturan-fitur-tambahan"
                  >
  ...
  methods: {
    ...
    handleActivateApproval() {
      if (this.userSubscription === "pro") {
        this.tempPengaturanFiturTambahan.approval = !this
          .tempPengaturanFiturTambahan.approval;
      } else {
