      ...
      >
        ...
        >
          <mp-text font-weight="semibold"
            >Anda dapat mengkustom tampilan laporan & mengurutkan akun.</mp-text
          >
                ...
                >
                  <mp-popover-list>
                    <mp-popover-list-item
                      @click="isModalAddNewCategoryOpen = true"
                      >Category</mp-popover-list-item
                    >
                    <mp-popover-list-item
                      @click="isModalAddNewNetCalculationOpen = true"
                    >
                      Net Calculation
                    </mp-popover-list-item>
                  </mp-popover-list>
          ...
          <mp-flex direction="column" justify="center" align="center" mb="8">
            <mp-text color="gray.600" text-align="center"
              >PT Central Perk Indonesia</mp-text
            >
            <InlineEditableText v-model="text" />
          </mp-flex>

          <!-- https://github.com/SortableJS/Sortable/tree/master/plugins/AutoScroll#options -->
          <Draggable
            tag="ul"
            v-model="datasets"
            v-bind="dragOptions"
          ...
          <ModalAddNewCategory
            :is-open="isModalAddNewCategoryOpen"
            @handleClose="isModalAddNewCategoryOpen = false"
            @handleSave="handleSaveAddNewCategory"
          />
