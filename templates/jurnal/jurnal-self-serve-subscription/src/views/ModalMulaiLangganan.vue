<template>
  <div>
            ...
            <mp-flex gap="3" align-items="center">
              <mp-flex>
                <mp-icon
                  ...
                  margin-right="2"
                  :variant="isPaketLanggananActive ? 'duotone' : 'outline'"
                />
                <mp-text
                  :color="isPaketLanggananActive ? '' : 'gray.600'"
                  :font-weight="isPaketLanggananActive ? 'semibold' : ''"
                >
                  Paket langganan
                </mp-text>
              </mp-flex>
              ...
              <mp-flex>
                <mp-icon
                  name="add-ons"
                  margin-right="2"
                  :variant="isKebutuhanTambahanActive ? 'duotone' : 'outline'"
                />
                <mp-text
                  :color="isKebutuhanTambahanActive ? '' : 'gray.600'"
                  :font-weight="isKebutuhanTambahanActive ? 'semibold' : ''"
                >
                  Kebutuhan tambahan
                </mp-text>
              </mp-flex>
              ...
              <mp-flex>
                <mp-icon
                  name="cart"
                  margin-right="2"
                  :variant="isKonfirmasiActive ? 'duotone' : 'outline'"
                />
                <mp-text
                  :color="isKonfirmasiActive ? '' : 'gray.600'"
                  :font-weight="isKonfirmasiActive ? 'semibold' : ''"
                >
                  Konfirmasi
                </mp-text>
              </mp-flex>
        ...
        <mp-modal-body>
            ...
            <mp-table :is-hoverable="false" :style="{ tableLayout: 'fixed' }">
                ...
                <mp-table-row :style="{ whiteSpace: 'normal' }">
                  ...
                  >
                    <mp-box p="2">
                      ...
                      <mp-text color="gray.600" line-height="md"
                        >Cocok untuk bisnis apa? Gak mesti dari company size,
                        lebih ke industri</mp-text
                      >
                      ...
                      <mp-button
                        ...
                        @click="
                          [
                            (stage = 2),
                            (isModalOpen.ModalDifferentPackage = true),
                          ]
                        "
                        >Pilih paket</mp-button
                      >
                    </mp-box>
                  </mp-table-cell>
                  <mp-table-cell
                  ...
                  >
                    <mp-box p="2">
                      ...
                      <mp-text color="gray.600" line-height="md"
                        >Mendukung transaksi multinasional dan integrasi
                        antar-aplikasi.</mp-text
                      >
                      ...
                      <mp-button width="full" mt="132px" @click="stage = 2"
                        >Pilih paket</mp-button
                      >
                    </mp-box>
                    ...
                    <mp-box
                      ...
                      px="4"
                      ml="-1px"
                      :width="tableCellWidth + 2"
                    >
                      <mp-text font-size="sm" font-weight="semibold" py="1"
                        >Paket anda saat ini
                      </mp-text>
                    </mp-box>
                  </mp-table-cell>
                  ...
                  >
                    <mp-box p="2">
                      ...
                      <mp-text color="gray.600" line-height="md"
                        >Solusi terlengkap untuk mendukung kemajuan bisnis tanpa
                        batas.</mp-text
                      >
              ...
              <mp-table-body>
                <template v-for="(value, index) in datas">
                  <mp-table-row :key="`parent-${index}-${value.id}`">
                    ...
                    >
                      <mp-flex align-items="center">
                        ...
                        <mp-badge v-if="value.label" ml="2">
                          {{ value.label }}
                        </mp-badge>
                      </mp-flex>
                    </mp-table-cell>
                  ...
                  <mp-table-row
                    v-for="(data, index2) in value.datas"
                    :key="`child-${index2}-${data.name}`"
                  >
                    <mp-table-cell
                      as="td"
                      scope="row"
                    ...
                    >
                      <mp-flex
                        ...
                        cursor="pointer"
                        @click="handleCollapsed(index, index2)"
                      >
                        ...
                        <mp-icon
                          ...
                          :transform="
                            data.isCollapsed ? 'rotate(-180deg)' : null
                          "
                        />
                      </mp-flex>
                    ...
                    >
                      <mp-flex justify="center" align-items="center">
                        <mp-icon
                          v-if="isBoolean(data.pro)"
                          :name="data.pro ? 'done' : 'error'"
                          variant="duotone"
                        />
                        <mp-text v-else font-weight="semibold">
                          {{ data.pro }}
                        </mp-text>
                      </mp-flex>
                    </mp-table-cell>
                    ...
                    >
                      <mp-flex justify="center" align-items="center">
                        <mp-icon
                          v-if="isBoolean(data.enterprise)"
                          :name="data.enterprise ? 'done' : 'error'"
                          variant="duotone"
                        />
                        <mp-text v-else font-weight="semibold">
                          {{ data.enterprise }}
                    ...
                    <mp-table-cell as="td" scope="row" border-color="gray.50">
                      <mp-flex justify="center" align-items="center">
                        <mp-icon
                          v-if="isBoolean(data.enterprisePlus)"
                          :name="data.enterprisePlus ? 'done' : 'error'"
                          variant="duotone"
                        />
                        <mp-text v-else font-weight="semibold">
                          {{ data.enterprisePlus }}
          ...
          <mp-box max-width="60%" mx="auto" v-if="stage === 2">
            <mp-stack spacing="6">
              ...
              <!-- Paket -->
              <mp-box rounded="sm" pl="5" py="5" pr="16">
                <mp-heading>Enterprise</mp-heading>
                ...
                <mp-grid templateColumns="repeat(9, 1fr)" gap="8" mt="4">
                  ...
                  <mp-grid-item col-span="3">
                    <mp-text font-weight="semibold" mb="1.5"
                      >Kuota dari paket</mp-text
                    >
                    <mp-flex align-items="center">
                      <mp-text>Faktur, gudang, & pengguna</mp-text>

                      <mp-tooltip
                        id="faktur-gudang-pengguna"
                        position="bottom-end"
                      >
                        ...
                        <template #label>
                          <mp-text font-size="sm">
                            10.000 faktur penjualan per bulan
                          </mp-text>
                          <mp-divider />
                  ...
                  <mp-grid-item col-span="2">
                    <mp-text font-weight="semibold" text-align="right" mb="1.5"
                      >Harga per bulan</mp-text
                    >
              ...
              <mp-box>
                <mp-text font-size="lg" font-weight="semibold"
                  >Kuota tambahan</mp-text
                >
                <mp-text color="gray.600" mb="1"
                  >Tambahkan kuota faktur, gudang, dan pengguna sesuai kebutuhan
                  bisnis Anda.</mp-text
                >
              ...
              <mp-box>
                <mp-text font-size="lg" font-weight="semibold"
                  >Fitur tambahan</mp-text
                >
                <mp-text color="gray.600" mb="1"
                  >Lengkapi proses bisnis Anda dengan fitur tingkat
                  lanjut.</mp-text
                >
          ...
          >
            ...
            <mp-flex>
              <mp-box text-align="right" mr="10">
                <mp-text font-size="lg" font-weight="semibold"
                  >Subtotal Rp4.794.000</mp-text
                >
                <mp-text font-size="sm" color="gray.400"
                  >Termasuk PPN 11%</mp-text
                >
              </mp-box>
    ...
    <ModalDifferentPackage
      :is-open="isModalOpen.ModalDifferentPackage"
      @handleClose="isModalOpen.ModalDifferentPackage = false"
    />
  </div>
</template>
...
import ModalDifferentPackage from "./ModalDifferentPackage.vue";
          ...
          datas: [
            {
              ...
              description:
                "Buat keputusan bisnis tepat dengan laporan keuangan dari arus kas hingga laba-rugi.",
              pro: true,
              enterprise: true,
              enterprisePlus: true,
            },
            {
              ...
              description:
                "Catat semua transaksi secara online dan real-time untuk hindari rekonsiliasi manual.",
              pro: true,
              enterprise: true,
              enterprisePlus: true,
            },
            {
              ...
              description:
                "Kelola semua produk dalam satu dasbor yang terupdate otomatis saat terjadi transaksi.",
              pro: true,
              enterprise: true,
              enterprisePlus: true,
            },
            {
              ...
              description:
                "Pantau pengeluaran dalam 30 hari terakhir termasuk yang belum dibayar di satu laporan real-time.",
              pro: true,
              enterprise: true,
              enterprisePlus: true,
            },
