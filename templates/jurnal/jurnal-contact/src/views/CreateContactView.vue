          ...
          <mp-stack spacing="16" max-width="70%">
              ...
              <mp-stack spacing="5">
                ...
                <mp-form-control>
                  ...
                  <mp-checkbox-group name="tipe-kontak" spacing="6" is-inline>
                    <mp-checkbox id="ekwAo" value="pelanggan">
                      Pelanggan
                    </mp-checkbox>
                    <mp-checkbox id="IXbuS" value="supplier">
                      Supplier
                    </mp-checkbox>
                    <mp-checkbox id="LMjMY" value="karyawan">
                      Karyawan
                    </mp-checkbox>
                    <mp-checkbox id="jMjMY" value="lainnya">
                      Lainnya
                    </mp-checkbox>
                  </mp-checkbox-group>
                </mp-form-control>
                ...
                <mp-form-control id="group-kontak">
                  ...
                  />
                  <mp-form-help-text
                    >Anda dapat memiih maksimal 3 grup</mp-form-help-text
                  >
                </mp-form-control>
              </mp-stack>
            </mp-box>
            ...
            <mp-box>
              <mp-flex mb="5" justify="space-between" align="center">
                ...
                <mp-button-icon
                  name="caret-down"
                  @click="collapse.infoUmum = !collapse.infoUmum"
                />
              </mp-flex>
              ...
              <mp-collapse :is-open="collapse.infoUmum">
                <mp-stack spacing="5">
                  ...
                  <mp-form-control>
                    ...
                    <mp-textarea
                      placeholder="Contoh: Jalan Indonesia Block C no. 22"
                    />
                  </mp-form-control>
                  ...
                  <mp-box position="relative">
                    <mp-checkbox v-model="isTambahRincian"
                      >Tambah rincian</mp-checkbox
                    >
                  </mp-box>

                  <mp-box v-if="isTambahRincian">
                    <mp-form-control
                      :is-disabled="isSamakanDenganAlamatPenagihan"
                    >
                      <mp-form-label>Alamat penagihan</mp-form-label>
                      <mp-textarea
                        placeholder="Contoh: Jalan Indonesia Block C no. 22"
                    ...
                    <mp-box position="relative" mt="1">
                      <mp-checkbox v-model="isSamakanDenganAlamatPenagihan"
                        >Samakan dengan alamat penagihan</mp-checkbox
                      >
                    </mp-box>
                  </mp-box>
            ...
            <mp-box>
              <mp-flex mb="5" justify="space-between" align="center">
                ...
                <mp-button-icon
                  name="caret-down"
                  @click="collapse.infoBank = !collapse.infoBank"
                />
              </mp-flex>
                ...
                <mp-box>
                  ...
                  >
                    <mp-divider
                      mb="6"
                      mt="11"
                      v-if="bankAccounts.length === 0 || index > 0"
                    />
                  ...
                  <mp-button
                    ...
                    @click="bankAccounts.push(bankAccounts.length + 1)"
                  >
                    <mp-icon
                      name="add-circular"
                      variant="duotone"
            ...
            <mp-stack spacing="5">
              <mp-flex justify="space-between" align="center">
                <mp-flex>
                  ...
                  <mp-text font-weight="semibold" font-size="lg"
                    >Pemetaan akun</mp-text
                  >
                </mp-flex>

                <mp-button-icon
                  name="caret-down"
                  @click="collapse.pemetaanAkun = !collapse.pemetaanAkun"
                />
              </mp-flex>
