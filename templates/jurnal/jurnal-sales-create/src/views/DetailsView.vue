        ...
        <mp-box min-height="calc(100vh - 132px)" border-top-width="1px" border-left-width="1px" rounded-top-left="md" background-color="white" padding="6">
          ...
          <mp-grid template-columns="repeat(12, 1fr)" gap="6">
            ...
            <mp-grid-item col-span="4">
              <mp-flex direction="column" align-items="flex-end">
                ...
                <ModalJournalEntry />
                <mp-flex gap="2" flex-wrap="wrap" mt="3" justify-content="flex-end">
                  ...
                  <PopoverTag label="Di kembalikan" tag-variant="red" trigger="hover">
                    <mp-flex direction="column" gap="2">
                      <mp-text font-weight="semibold">Pembayaran berhasil dikembalikan</mp-text>
                      <mp-text>Pengembalian pembayaran dilakukan oleh John Wick pada 25/03/2021.</mp-text>
                      <mp-text is-link>Lihat pengembalian pembayaran</mp-text>
          ...
          <mp-flex justify-content="space-between">
            <mp-box width="50%">
              <mp-stack gap="2">
                <mp-flex>
                  <mp-box flex="none" width="80px" mr="6">
                    <mp-text color="gray.600"> Pesan </mp-text>
                  </mp-box>
                  <mp-box>
                    <TextElipsisCollapsible id="message" line-clamp="8">
                      Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce dignissim iaculis dolor in auctor. Nunc a metus quis tortor viverra cursus
                      nec id ipsum. Nulla auctor laoreet ante, id lacinia nisi feugiat sit amet. Nullam ut vulputate felis. Duis suscipit tristique interdum.
                      Nunc felis ipsum, condimentum sit amet egestas quis, hendrerit sed justo. Suspendisse potenti. Proin lorem sem, faucibus quis rhoncus ac,
                      dignissim nec sem. Etiam fermentum gravida nunc in ullamcorper. Ut a laoreet metus, ut mollis nibh. Integer purus tellus, tempor vitae
                      velit a, finibus eleifend orci. Maecenas fermentum leo erat. Nunc purus nunc, euismod ut blandit vitae, imperdiet ut lorem.
                ...
                <mp-flex>
                  ...
                  <mp-box>
                    <TextElipsisCollapsible id="message" line-clamp="8"> Terusan dari incoive 12/11/2022 </TextElipsisCollapsible>
                  </mp-box>
                </mp-flex>
            ...
            <mp-box>
              <mp-flex gap="2">
                ...
                <mp-popover>
                  ...
                  <mp-popover-content min-width="180px" width="max-content" max-width="90vw" bg="white" rounded="md" shadow="lg" border-width="1px" border-color="gray.400">
                    <mp-popover-list>
