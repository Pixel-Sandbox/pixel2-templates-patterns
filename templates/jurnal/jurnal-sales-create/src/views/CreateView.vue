        ...
        <mp-box min-height="calc(100vh - 132px)" border-top-width="1px" border-left-width="1px" rounded-top-left="md" background-color="white" padding="6">
          ...
          >
            ...
            <mp-grid-item display="flex" align-items="flex-end" pb="2">
              <mp-checkbox v-model="infoPengiriman">Info pengiriman</mp-checkbox>
            </mp-grid-item>
          ...
          >
            ...
            <mp-grid-item v-if="infoPengiriman" display="inline-flex" flex-direction="column" gap="6">
              <mp-form-control>
            ...
            <mp-grid-item display="inline-flex" flex-direction="column" gap="6">
              ...
              <mp-form-control>
                <mp-form-label align-items="center"
                  >Tag
                  <mp-text as="span" color="gray.600" ml="1" font-size="sm" line-height="sm">(10)</mp-text>
                </mp-form-label>
                <mp-input-tag
