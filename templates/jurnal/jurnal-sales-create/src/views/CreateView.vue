  ...
  <mp-box>
    ...
    <mp-flex as="main" max-height="calc(100vh - 60px)">
        ...
        >
          ...
          >
            ...
            <mp-grid-item display="flex" align-items="flex-end" pb="2">
              <mp-checkbox v-model="infoPengiriman"
                >Info pengiriman</mp-checkbox
              >
            </mp-grid-item>
          ...
          <mp-grid
            :template-columns="{
              ...
              sm: 'repeat(2, 1fr)',
              md: 'repeat(3, 1fr)',
              lg: infoPengiriman ? 'repeat(5, 1fr)' : 'repeat(4, 1fr)',
            }"
            gap="6"
          >
            <mp-grid-item display="inline-flex" flex-direction="column" gap="6">
              ...
              <mp-box>
                ...
                <mp-checkbox mt="1" v-model="isSameWithBillingAddress">
            ...
            >
              <mp-form-control>
                <mp-form-label>Tanggal pengiriman</mp-form-label>
                <mp-date-picker />
              </mp-form-control>

              <mp-form-control>
                <mp-form-label>Kirim melalui </mp-form-label>
                <mp-input />
              </mp-form-control>

              <mp-form-control>
                <mp-form-label>No pelacakan </mp-form-label>
                <mp-input />
              </mp-form-control>
            </mp-grid-item>
                      ...
                      <template #label>
                        <mp-flex direction="column">
                          <mp-text as="span" color="white"
                            >Nomor transaksi akan dihitung secara otomatis oleh
                            sistem. Klik di sini untuk mengatur nomor
                            transaksi.</mp-text
                          >
                          ...
                          <mp-text
                            ...
                            color="white"
                          >
                            Perkiraan nomor: RCA.INV/123/2022
                          </mp-text>
                        </mp-flex>
                      </template>
                    </mp-tooltip>
            ...
            <mp-grid-item display="inline-flex" flex-direction="column" gap="6">
              <mp-form-control min-height="63px">
                  ...
                  <mp-box>
                    <mp-text
                      ...
                      <mp-text
                        ...
                        as="span"
                        @click.native="isModalUpdateRateOpen = true"
                        >Ubah kurs</mp-text
                      >
                    </mp-text>
          ...
          >
              ...
              <mp-flex flex-direction="column">
                <mp-form-control margin-bottom="5">
                  <mp-flex align="center" gap="1" mb="1">
                    ...
                    <mp-tooltip
                      label="File can be excel, Word, PDF, JPG, PNG, or ZIP (10 MB in total)."
                      id="attachment-info"
                      width="209px"
                    >
                  ...
                  <mp-upload
                    ...
                    max-width="full"
                  />
                  <mp-text display="inline" font-size="sm" color="gray.600">
                    File can be document, image, or ZIP
                  </mp-text>
                </mp-form-control>
              </mp-flex>
            </mp-box>
            ...
            >
              <mp-box>
                ...
                <mp-flex mb="5">
                  <mp-box flex="none">
                    <mp-checkbox v-model="rightTotal.pemotongan">
                      {{ rightTotal.pemotongan ? "" : "Pemotongan" }}
                    </mp-checkbox>
                  </mp-box>
                  <mp-box w="full" v-if="rightTotal.pemotongan">
                    ...
                    >
                      <mp-flex gap="2">
                        ...
                        <mp-input-group>
                          <mp-input-left-addon>
                            <mp-text px="2" font-weight="semibold">
                              Rp
                            </mp-text>
                          </mp-input-left-addon>
                ...
                <mp-box>
                  <mp-flex justify-content="space-between" align-items="center">
                    <mp-checkbox v-model="rightTotal.uangMuka">
                      Uang muka
                    </mp-checkbox>
          ...
          <mp-flex justify="flex-end" mt="8">
            <mp-button variant="ghost" @click="isModalCancelOpen = true">
              Batalkan
            </mp-button>
                ...
                >
                  <mp-popover-list>
                    <mp-popover-list-item
                      ...
                      >Simpan dan bagikan via WhatsApp
                      <mp-badge ml="2"> Baru </mp-badge></mp-popover-list-item
                    >
                    <mp-popover-list-item @click="isModalSendEmailOpen = true"
                      >Simpan dan bagikan via email</mp-popover-list-item
                    >
                    <mp-popover-list-item @click="handleSave"
                      >Simpan dan buat baru</mp-popover-list-item
                    >
                  </mp-popover-list>
                </mp-popover-content>
              </mp-popover>
      ...
      <ModalPaymentRequirement
        :is-open="isModalPaymentRequirementOpen"
        @handleClose="isModalPaymentRequirementOpen = false"
      />
      <ModalTransactionNumberSetting
        :isOpen="isModalTransactionNumberSettingOpen"
        @handleClose="isModalTransactionNumberSettingOpen = false"
      />
      <ModalUpdateRate
        :isOpen="isModalUpdateRateOpen"
        @handleClose="isModalUpdateRateOpen = false"
      />
      <ModalCancel
        :isOpen="isModalCancelOpen"
        @handleClose="isModalCancelOpen = false"
      />
      <ModalSendEmail
        :isOpen="isModalSendEmailOpen"
        @handleClose="isModalSendEmailOpen = false"
      />
      <ModalSendWhatsApp
        :isOpen="isModalSendWhatsAppOpen"
        @handleClose="isModalSendWhatsAppOpen = false"
      />
      <DrawerAddContact
        :isOpen="isDrawerAddContactOpen"
        @close="isDrawerAddContactOpen = false"
      />
    </mp-flex>
  </mp-box>
</template>
