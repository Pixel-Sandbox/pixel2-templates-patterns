              ...
              <mp-stack spacing="4">
                <mp-box border-width="1px" p="6" bg="white" rounded="sm">
                  <mp-grid templateColumns="repeat(5, 1fr)">
                    ...
                    <mp-grid-item col-span="4">
                      <mp-text font-size="lg" font-weight="semibold"
                        >Pro (Aktif hingga 31 Des 2022)</mp-text
                      >
                    </mp-grid-item>
                  </mp-grid>
                  ...
                  <mp-grid templateColumns="repeat(5, 1fr)" mt="5">
                    <mp-grid-item col-start="2" col-end="4">
                      <mp-text color="gray.600" font-weight="semibold"
                        >Gratis</mp-text
                      >
                      <mp-box as="ul" list-style-position="inside">
                        <mp-text as="li" color="gray.600">
                          Pengguna: 3 dari 3 pengguna</mp-text
                        >
                        <mp-text as="li" color="gray.600">
                          Jurnal touch: 1 dari 1 device</mp-text
                        >
                        <mp-text as="li" color="gray.600">
                          Moka add-ons: 1 dari 1 koneksi</mp-text
                        >
                      </mp-box>
                    </mp-grid-item>
                    <mp-grid-item col-span="2">
                      ...
                      <mp-box as="ul" list-style-position="inside">
                        <mp-text as="li" color="gray.600">
                          Pengguna: 1 pengguna</mp-text
                        >
                        <mp-text as="li" color="gray.600">
                          Partner: 1 partner</mp-text
                        >
                        <mp-text as="li" color="gray.600">
                          Jurnal Touch: 1 device</mp-text
                        >
                        <mp-text as="li" color="gray.600">
                          Moka Add-Ons: 1 koneksi</mp-text
                        >
                      </mp-box>
                    </mp-grid-item>
                  </mp-grid>
                ...
                <mp-box border-width="1px" p="6" bg="white" rounded="sm">
                  <mp-flex justify="space-between" mb="5">
                    <mp-text font-size="lg" font-weight="semibold"
                      >Langganan Jurnal (01 Jan 2020 – 31 Des 2020)</mp-text
                    >
                        ...
                        <mp-table-body>
                          ...
                          <mp-table-row v-if="penggunaTambahan">
                            ...
                            <mp-table-cell as="td" scope="row">
                              <mp-flex>
                                ...
                                <mp-tooltip
                                  label="Durasi mengikuti sisa periode paket aktif Anda."
                                >
                                  <mp-icon name="info" />
                                </mp-tooltip>
                              </mp-flex>
                            ...
                            <mp-table-cell as="td" scope="row">
                              <mp-flex justify="flex-end">
                                <mp-button-icon
                                  name="minus-circular"
                                  @click="handleRemovePenggunaTambahan"
                                />
                              </mp-flex>
                            </mp-table-cell>
                          </mp-table-row>
                          <mp-table-row
                            v-if="!penggunaTambahan"
                            key="tambah-lainnya"
                          >
                                ...
                                >
                                  <mp-popover-list>
                                    <mp-popover-list-item
                                      @click="handleAddPenggunaTambahan"
                          ...
                          <mp-table-row>
                            ...
                            <mp-table-cell
                              ...
                              border-bottom-color="transparent"
                            >
                              <mp-text font-weight="semibold" text-align="right"
                                >Rp555.400</mp-text
                              >
                            </mp-table-cell>
                            <mp-table-cell
                ...
                <mp-box border-width="1px" p="6" bg="white" rounded="sm">
                  <mp-form-control control-id="metode-pembyaran">
                    ...
                    <mp-radio-group
                      ...
                      name="metode-pembyaran"
                      spacing="6"
                      is-inline
                    >
                      <mp-radio id="kartu-kredit" value="kartu-kredit">
                        Kartu kredit
                      </mp-radio>
                  ...
                  <template v-if="paymentMethod === 'kartu-kredit'">
                    ...
                    <mp-box mt="5">
                      <mp-text font-weight="semibold" mb="1"
                        >Persetujuan penagihan otomatis</mp-text
                      >
                      <mp-flex
                        p="3.2"
                        bg="orange.50"
                      ...
                      >
                        ...
                        <mp-box ml="3">
                          <mp-text>
                            Saya mengizinkan pihak Jurnal untuk mengenakan
                            pembayaran otomatis terhadap kartu kredit saya.
                            Butuh info pembatalan atau modifikasi izin ini?
                            <mp-text as="span" is-link
                              >Hubungi tim Jurnal</mp-text
                            >
                          </mp-text>
                        </mp-box>
                      </mp-flex>
              ...
              <mp-box border-width="1px" p="6" bg="white" rounded="sm">
                ...
                <mp-box mt="5">
                  ...
                  >
                    ...
                    />
                    <mp-text font-weight="semibold">
                      <mp-text as="span" color="blue.400" font-weight="semibold"
                        >Diskon 15%</mp-text
                      >
                      berhasil didapatkan</mp-text
                    >
                  </mp-flex>
                  ...
                  <mp-flex justify="end" mt="5">
                    <mp-button-group>
                      <mp-button variant="ghost" as="router-link" to="/"
                        >Kembali</mp-button
                      >
