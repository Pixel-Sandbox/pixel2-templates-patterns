    ...
    <mp-modal-content>
      ...
      <mp-modal-body>
          ...
          <mp-flex align-items="start" position="relative">
            ...
            <mp-box ml="3">
              ...
              <mp-text font-size="sm" color="gray.600"
                >Mendapatkan 1.000 kuota tambahan. Masa berlaku kuota sama
                dengan paket langganan.
              </mp-text>
            </mp-box>
          ...
          <mp-flex align-items="start" position="relative">
            ...
            <mp-box ml="3">
              <mp-text font-size="lg" font-weight="semibold"
                >Sekali bayar</mp-text
              >
              <mp-text>Rp199.000</mp-text>
              <mp-text font-size="sm" color="gray.600"
                >Mendapatkan X.XXX kuota tambahan. Masa berlaku kuota sesuai
        ...
        <mp-flex mt="5" justify="end">
          <mp-button-group>
            <mp-button variant="outline" @click="handleClose">
              Batalkan
            </mp-button>
            <mp-button @click="handleAdd" :is-disabled="!selected">
              Tambahkan
            </mp-button>
          </mp-button-group>
        </mp-flex>
