        ...
        >
          ...
          <mp-grid template-columns="repeat(12, 1fr)" gap="6">
            ...
            <mp-grid-item col-span="4">
              <DisplayContent title="Email">
                <mp-flex gap="2" flex-wrap="wrap">
                  ...
                  <mp-tag variant="gray" size="sm">
                    Jakapermadi@mekari.com
                  </mp-tag>
                </mp-flex>
              </DisplayContent>
            </mp-grid-item>
            <mp-grid-item col-span="4">
              <mp-flex direction="column" align-items="flex-end">
                <mp-heading font-size="xl"
                  >Sisa tagihan Rp12.500.000,00</mp-heading
                >
                <ModalJournalEntry />
                <mp-flex
                  gap="2"
                ...
                >
                  <PopoverTag label="Memiliki eFaktur" trigger="hover">
                    <mp-flex direction="column" gap="2">
                      <mp-text font-weight="semibold"
                        >Digunakan sebagai tukar faktur</mp-text
                      >
                      <mp-text
                        >Faktur ini digabungkan dengan faktur lain pada
                        24/05/2022 oleh Dini Damayanti</mp-text
                      >
                  ...
                  <PopoverTag label="Transaksi berulang" trigger="hover">
                    <mp-flex direction="column" gap="2">
                      <mp-text font-weight="semibold"
                        >Transaksi ini diatur berulang</mp-text
                      >
                      <mp-text
                        >Periode pengulangan: 1 bulan Akhir pengulangan: tidak
                        pernah
                      </mp-text>
                  ...
                  <PopoverTag label="Tukar faktur" trigger="hover">
                    <mp-flex direction="column" gap="2">
                      <mp-text font-weight="semibold"
                        >Pembayaran berhasil dikembalikan</mp-text
                      >
                      <mp-text
                        >Pengembalian pembayaran dilakukan oleh John Wick pada
                        25/03/2021.</mp-text
                      >
            ...
            <mp-grid-item col-span="4">
              <mp-stack gap="2">
                <DisplayContent title="Alamat penagihan">
                  <mp-text>
                    Midplaza 2, No 4, RT 00001, RW 00018 Karet Tengsin, Tanah
                    Abang, 10220, Daerah Khusus Ibukota Jakarta, Indonesia
                  </mp-text>
                </DisplayContent>

                <DisplayContent title="Alamat pengiriman">
                  <mp-text>
                    Perum Shoji Land EF-17, Cluster Etsu Garden, RT 00001 RW
                    00020, Sambiroto, Karangtanjung, Kecamatan Candi, Kabupaten
                    Sidoarjo, Provinsi Jawa Timur, Indonesia
                  </mp-text>
                </DisplayContent>
              </mp-stack>
            </mp-grid-item>
          ...
          <mp-flex justify-content="space-between">
            <mp-box width="50%">
              <mp-stack gap="2">
                <mp-flex>
                  <mp-box flex="none" min-width="80px" max-width="120px" mr="6">
                    <mp-text color="gray.600"> Pesan </mp-text>
                  </mp-box>
                  <mp-box>
                    <TextElipsisCollapsible id="message" line-clamp="8">
                      Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                      Fusce dignissim iaculis dolor in auctor. Nunc a metus quis
                      tortor viverra cursus nec id ipsum. Nulla auctor laoreet
                      ante, id lacinia nisi feugiat sit amet. Nullam ut
                      vulputate felis. Duis suscipit tristique interdum. Nunc
                      felis ipsum, condimentum sit amet egestas quis, hendrerit
                      sed justo. Suspendisse potenti. Proin lorem sem, faucibus
                      quis rhoncus ac, dignissim nec sem. Etiam fermentum
                      gravida nunc in ullamcorper. Ut a laoreet metus, ut mollis
                      nibh. Integer purus tellus, tempor vitae velit a, finibus
                      eleifend orci. Maecenas fermentum leo erat. Nunc purus
                      nunc, euismod ut blandit vitae, imperdiet ut lorem.
                ...
                <mp-flex>
                  ...
                  <mp-box>
                    <TextElipsisCollapsible id="message" line-clamp="8">
                      Terusan dari incoive 12/11/2022
                    </TextElipsisCollapsible>
                  </mp-box>
                </mp-flex>

                <mp-box max-width="300px">
                    ...
                    <mp-flex>
                      ...
                      <mp-box flex="1 1 0%" pl="3">
                        <mp-text
                          ...
                          is-link
                          line-height="md"
                          @click.native="isModalAttachmentPreviewOpen = true"
                        >
                          AemZaht.png
                        </mp-text>
                        <mp-text color="gray.400" line-height="md">
                          1.3 MB
                        </mp-text>
                      </mp-box>
                      <mp-box flex="none">
                        <mp-tooltip label="Download" id="download-01">
                          <mp-button-icon
                            name="download"
                            @click="
                              downloadImage('https://i.imgur.com/AemZaht.png')
                            "
                          />
                        </mp-tooltip>
                      </mp-box>
          ...
          <mp-box mt="8">
            <mp-text @click.native="isModalAuditOpen = true" is-link
              >Terakhir diubah oleh sistem pada 30 Nov 2023, 11:00
              (GMT+7)</mp-text
            >
          </mp-box>
          <mp-divider border-style="dashed" my="6" />
          ...
          >
            <mp-box>
              <mp-button
                variant="ghost"
                @click="isModalDeleteThisRequestOpen = true"
              >
                Hapus
              </mp-button>
            </mp-box>
            <mp-box>
              <mp-flex gap="2">
                <mp-button variant="ghost" @click="handleEditPurchaseRequest">
                  Ubah
                </mp-button>
                <mp-popover>
                  <mp-popover-trigger>
                  ...
                  >
                    <mp-popover-list>
                      ...
                      <mp-popover-list-item @click="isModalPrintPdfOpen = true"
                        >Lihat template faktur</mp-popover-list-item
                      >
                      <mp-popover-list-item
                        >Lihat surat jalan</mp-popover-list-item
                      >
                      ...
                      <mp-popover-list-item
                        @click="isModalSendWhatsAppOpen = true"
                        >Kirim via WhatsApp

                        <mp-badge variant-color="blue" ml="2">New</mp-badge>
                      </mp-popover-list-item>
                      <mp-popover-list-item @click="isModalSendEmailOpen = true"
                        >Kirim via email</mp-popover-list-item
                      >
                      <mp-popover-list-item
                        @click="isModalGetJournalLinkOpen = true"
                        >Dapatkan link faktur</mp-popover-list-item
                      >
                    </mp-popover-list>
                  </mp-popover-content>
                </mp-popover>
                ...
                <mp-popover>
                  ...
                  >
                    <mp-popover-list>
                      <mp-popover-list-item
                        @click="isModalPrintInvoiceDotMatrixOpen = true"
                        >Faktur</mp-popover-list-item
                      >
                ...
                <mp-popover>
                  <mp-popover-trigger>
                    <mp-button variant="solid" right-icon="caret-down">
                      Action
                    </mp-button>
                  </mp-popover-trigger>
                  <mp-popover-content
                  ...
                  >
                    <mp-popover-list>
                      <mp-popover-list-item
                        @click="isModalDuplicateTransactionOpen = true"
                      >
                        Duplikat transaksi
                      </mp-popover-list-item>
                      <mp-popover-list-item
                        @click="isModalRecurringTransactionOpen = true"
                      >
                        Atur transaksi berulang
                      </mp-popover-list-item>
                      <mp-popover-list-item>
                        Buat faktur pro forma
                      </mp-popover-list-item>
                      <mp-popover-list-item>
                        Terima pembayaran
                      </mp-popover-list-item>
                      <mp-popover-list-item
                        @click="isModalCloseSalesOrderOpen = true"
                      >
                        Tutup pemesanan
                      </mp-popover-list-item>
                      <mp-popover-list-item>
          ...
          <!-- Modal -->
          <ModalAudit
            :is-open="isModalAuditOpen"
            @handleClose="isModalAuditOpen = false"
          />
          <ModalDeleteThisRequest
            :is-open="isModalDeleteThisRequestOpen"
            @handleClose="isModalDeleteThisRequestOpen = false"
          />
          <ModalPrintPdf
            :is-open="isModalPrintPdfOpen"
            @handleClose="isModalPrintPdfOpen = false"
          />
          ...
          />
          <ModalSendWhatsApp
            :is-open="isModalSendWhatsAppOpen"
            @handleClose="isModalSendWhatsAppOpen = false"
          />
          <ModalSendEmail
            :is-open="isModalSendEmailOpen"
            @handleClose="isModalSendEmailOpen = false"
          />
          <ModalGetJournalLink
            :is-open="isModalGetJournalLinkOpen"
            @handleClose="isModalGetJournalLinkOpen = false"
          />
          <ModalDuplicateTransaction
            :is-open="isModalDuplicateTransactionOpen"
            @handleClose="isModalDuplicateTransactionOpen = false"
          />
          <ModalRecurringTransaction
            :is-open="isModalRecurringTransactionOpen"
            @handleClose="isModalRecurringTransactionOpen = false"
          />
          <ModalCreditMemo
            :is-open="isModalCreditMemoOpen"
            @handleClose="isModalCreditMemoOpen = false"
          />
          <ModalEmailConfirmation
            :is-open="isModalEmailConfirmationOpen"
            @handleClose="isModalEmailConfirmationOpen = false"
          />
          <ModalCloseSalesOrder
            :is-open="isModalCloseSalesOrderOpen"
            @handleClose="isModalCloseSalesOrderOpen = false"
          />
          <ModalPrintInvoiceDotMatrix
            :is-open="isModalPrintInvoiceDotMatrixOpen"
            @handleClose="isModalPrintInvoiceDotMatrixOpen = false"
          />
        </mp-box>
      </mp-box>
    </mp-flex>
...
import { TextElipsisCollapsible } from "./details-parts/TextElipsisCollapsible";
