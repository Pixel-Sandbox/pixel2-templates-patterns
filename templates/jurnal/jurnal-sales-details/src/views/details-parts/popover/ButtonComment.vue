    ...
    <mp-modal size="lg" :isOpen="isOpen">
      <mp-modal-content>
        ...
        <mp-modal-body>
          ...
          >
            <img
              src="../../../assets/Noinbox_PNG_001_Interlaced 1.png"
              alt=""
              my="3"
            />
            <mp-text py="4" color="gray.600"
              >Belum ada komentar untuk transaksi ini.</mp-text
            >
          </mp-flex>
          ...
          >
              ...
              <mp-stack spacing="1" ml="4">
                  ...
                  <mp-flex py="2" px="3" rounded="8px" bg="#F2F4F7">
                    ...
                    <mp-box flex="none" width="50px">
                      <mp-flex align="end" h="full" justify="end">
                        <mp-text font-size="xs" color="blackAlpha.500"
                          >08:12 AM</mp-text
                        >
                      </mp-flex>
                    </mp-box>
                ...
                <mp-flex id="chat-bubble">
                  <mp-flex bg="#F2F4F7" py="2" px="3" rounded="8px">
                    <mp-box flex-grow="1" pr="2">
                      <mp-text
                        >cupidatat non proident, sunt in culpa qui</mp-text
                      >
                    </mp-box>
            ...
            <mp-flex id="timestamp" justify="center">
              <mp-text font-size="xs" color="gray.400"
                >Tue, 11 Jan 2022</mp-text
              >
            </mp-flex>
                  ...
                  <mp-flex py="2" px="3" rounded="8px" bg="#F2F4F7">
                    <mp-box flex-grow="1" width="full" pr="2">
                      <mp-text
                        ...
                        font-weight="semibold"
                        mb="2"
                        >Andy Bernard</mp-text
                      >
                      <mp-text
                        >Sunt in culpa qui officia deserunt
                        <mp-text as="span" color="brand.jurnal">
                          @Jim Halpert
                        </mp-text>
                        mollit anim id est laborum</mp-text
                      >
                    </mp-box>
                ...
                <mp-flex id="chat-bubble">
                  <mp-flex py="2" px="3" rounded="8px" bg="#F2F4F7">
                    <mp-box flex-grow="1" width="full" pr="2">
                      ...
                      >
                      <mp-text
                        >Lorem ipsum dolor sit amet, deniem consectetur
                        adipiscing elit. Ut pretium pretium tempor.</mp-text
                      >
                    </mp-box>
        ...
        <mp-modal-footer border-top-width="1px" border-top-color="gray.100">
          <mp-flex v-if="isApproved" width="full" justify="center" mt="3">
            <mp-text font-size="sm" color="gray.600"
              >View only. Transaction is already approved</mp-text
            >
          </mp-flex>
                  ...
                  <mp-popover-list-item v-for="index in 4" :key="index">
                    <mp-flex align-items="center">
                      ...
                      <mp-box margin-left="3">
                        <mp-text font-size="md" line-height="1sm">
                          Christin Purnama Sari
                        </mp-text>
                        <mp-text
                          font-size="sm"
                          line-height="sm"
