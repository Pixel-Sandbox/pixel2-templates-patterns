        ...
        <mp-drawer-body>
          <mp-grid gap="4">
            ...
            <mp-flex gap="3">
              ...
              <mp-form-control
                width="100%"
                v-if="state.berakhir === 'Setelah kali ke'"
              >
                <mp-form-label>‎</mp-form-label>
                <mp-input-group>
                  <mp-input value="0" />
              ...
              <mp-form-control
                width="100%"
                v-if="state.berakhir === 'Pada tanggal'"
              >
                <mp-form-label>‎</mp-form-label>
                <mp-date-picker />
              </mp-form-control>
            ...
            <mp-form-control>
              ...
              <mp-date-picker />
              <mp-checkbox mt="2">
                Tetapkan tanggal transaksi berikutnya pada akhir bulan
              </mp-checkbox>
            </mp-form-control>
            ...
            <mp-form-control>
              ...
              <mp-checkbox>
                Email akan dikirimkan sesuai tanggal transaksi berulang
              </mp-checkbox>
            </mp-form-control>
          </mp-grid>
        </mp-drawer-body>
