<template>
  <PixelPageContainer :is-full-screen="isFullScreen">
    <mp-box id="pixelPageHeader">
      ...
      >
        <mp-box>
          <mp-text v-if="!isFullScreen" color="blue.400"
            >Daftar laporan</mp-text
          >
        ...
        <mp-box
          :transform="isFullScreen ? 'scale(1)' : 'scale(0.2)'"
          :opacity="isFullScreen ? 1 : 0"
          transition="all 0.3s ease-out"
        >
          <mp-button-icon
            v-mp-tooltip="'Tampilkan lebih kecil'"
            name="full-screen"
    ...
    >
      <mp-collapse :is-open="!isFullScreen">
        <mp-flex justify-content="space-between" mb="6">
          ...
          <mp-flex align-items="center" gap="3">
            <mp-button-icon
              v-mp-tooltip="'Tampilkan lebih besar'"
              name="full-screen"
      ...
      >
        ...
        <TableStickyContainer
          :is-visible="isStickyHeaderVisible"
            ...
            <mp-table-head-lite>
              ...
              <mp-table-row-lite>
                <mp-table-cell-lite
                  ...
                  border-left-width="1px"
                  text-align="center"
                  :width="stickySubHeaderWidth[0] + 'px'"
                  transition="width 300ms cubic-bezier(0.4, 0, 0.2, 1)"
                >
                  Debit
                </mp-table-cell-lite>
                <mp-table-cell-lite
                  ...
                  border-left-width="1px"
                  text-align="center"
                  :width="stickySubHeaderWidth[1] + 'px'"
                  transition="width 300ms cubic-bezier(0.4, 0, 0.2, 1)"
                >
                  Credit
                </mp-table-cell-lite>
                <mp-table-cell-lite
                  ...
                  border-left-width="1px"
                  text-align="center"
                  :width="stickySubHeaderWidth[2] + 'px'"
                  transition="width 300ms cubic-bezier(0.4, 0, 0.2, 1)"
                >
                  Debit
                </mp-table-cell-lite>
                <mp-table-cell-lite
                  ...
                  border-left-width="1px"
                  text-align="center"
                  :width="stickySubHeaderWidth[3] + 'px'"
                  transition="width 300ms cubic-bezier(0.4, 0, 0.2, 1)"
                >
                  Credit
                </mp-table-cell-lite>
                <mp-table-cell-lite
                  ...
                  border-left-width="1px"
                  text-align="center"
                  :width="stickySubHeaderWidth[4] + 'px'"
                  transition="width 300ms cubic-bezier(0.4, 0, 0.2, 1)"
                >
                  Debit
                </mp-table-cell-lite>
                <mp-table-cell-lite
                  ...
                  border-left-width="1px"
                  text-align="center"
                  :width="stickySubHeaderWidth[5] + 'px'"
                  transition="width 300ms cubic-bezier(0.4, 0, 0.2, 1)"
                >
                  Credit
                </mp-table-cell-lite>
          ...
          <mp-table-lite :is-hoverable="false" ref="table">
            ...
            <mp-table-body-lite>
              <template v-for="(group, index) in reportDatas">
                ...
                <mp-table-row-lite
                  v-for="(report, index) in group.childrens"
                  :key="report.account"
                >
                  <mp-table-cell-lite
                    as="td"
                    ...
                    px="1"
                    :border-bottom-width="
                      index === group.childrens.length - 1 ? '0px' : '1px'
                    "
                  >
                    <mp-text>
        ...
        <TableStickyContainer
          :is-visible="isStickyFooterVisible"
          placement="bottom"
        >
          <mp-table-lite :is-hoverable="false" table-layout="fixed">
            <mp-table-head-lite>
